...
<div class="contact">
    <p class="title" id="point_reserve">席予約</p>
        <form action="./confirm.php" class="form" method="post">
            <div class="input_area">
                ...
                <div class="form_content">
                    <label for="name" class="form_content_name">お名前<span>※必須</span></label>
                ...
                <div class="form_content">
                    <label for="seat" class="form_content_name">席の場所<span>※必須</span></label>
        ...
        ?>
                ...
                <div class="form_content">
                    <label for="email" class="form_content_name">メールアドレス<span >※必須</span></label>
                ...
                <div class="form_content">
                    <label for="tel" class="form_content_name">電話番号<span>※任意</span></label>
                ...
                <div class="form_submit">
                     <input type="submit" value="送信" class="form_write submit_botton" disabled>
                </div>
