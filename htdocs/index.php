...
<div class="swiper" id="lp-first-view">
...
<div class="contact">
    <p class="title" id="point_reserve">席予約</p>
        <form action="./confirm.php" class="form" id="form" method="post">
            <div class="input_area">
              ...
              <option value="<?php echo $seat; ?>" <?php echo ($selectedSeat == $seat ? "selected" : ""); ?>>
                ...
                <div class="form_content">
                    ...
                    <input type="tel" name="tel" placeholder="例:09012345678" class="form_write ninni" value="<?php echo isset($_POST['tel']) ? htmlspecialchars($_POST['tel']) : ''; ?>">
                    <p class="telError" id="telError" style="color:red; display:none;">電話番号は10-11文字で入力してください</p>
                </div>

                <div class="form_submit">
                     <input type="submit" value="送信" class="form_write submit_botton js-submit-validation" >
                </div>
